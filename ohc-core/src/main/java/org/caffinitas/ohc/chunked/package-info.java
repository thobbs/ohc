 ...
 * </p>
 * <p>
 * Each segment is responsible for a portion of the total capacity ({@code capacity / segmentCount}).
 * This amount of memory is allocated once up-front during initialization and logically divided into
 * a configurable number of chunks. The size of each chunk is configured using the {@code chunkSize}
